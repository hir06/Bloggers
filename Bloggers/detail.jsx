...
class Detail extends React.Component {
  ...
  increaseLike(e, comment) {
    ...
    if (localStorage.getItem(comment.id).split(",")[0] == undefined) {
      comment.like = 0;
    } else {
      comment.like = localStorage.getItem(comment.id).split(",")[0];
    }
    if (localStorage.getItem(comment.id).split(",")[1] == undefined) {
      comment.dislike = 0;
    } else {
              ...
              <div className="row" key={i}>
                ...
                <div className="portfolio-item">
                  ...
                  <div>
                    ...
                    <span className="right"> ({localStorage.getItem(cmm.id).split(",")[1]})</span>
                    <i
                    ...
                    <span className="right"> ({localStorage.getItem(cmm.id).split(",")[0]})</span>
